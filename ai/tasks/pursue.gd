...
func _tick(_delta: float) -> Status:
	...
	print("are we in tolerance %s %s" % [desired_pos,TOLERANCE])
	#print("agent.global_position.distance_to(%s) < TOLERANCE: Resuit: " % [desired_pos, TOLERANCE, (agent.global_position.distance_to(desired_pos) < TOLERANCE)])
